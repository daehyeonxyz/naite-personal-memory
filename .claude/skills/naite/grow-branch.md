...
All data paths below resolve against **NAITE_ROOT** (the root of the naite vault). Sub-skill references resolve against **SKILL_DIR** (`<NAITE_ROOT>/.claude/skills/naite`). See `SKILL.md` for context.
