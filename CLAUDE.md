...
**Read `CONTEXT.md`, `CONVENTIONS.md`, plus the relevant workflow file under `.claude/skills/naite/`.** Do not improvise context loading, schema, naming, rings format, frontmatter facets, or page shape — invariants live in those files. This is non-negotiable: a tree edit without those reads is drift.
