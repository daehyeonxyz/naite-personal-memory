...
- **과정도 프리앰블도 없이 곧장 본론으로 시작한다.** 무슨 파일을 읽고 어떻게 라우팅하는지, 그리고 "이제 답하겠습니다", "좋은 질문입니다", "Now I have solid grounding. Let me answer." 같은 사고·전환 메타 문장은 (한국어든 영어든) 본문에 적지 않는다. 답변은 첫 글자부터 사용자가 원하는 결론으로 시작한다 (`SOUL.md § 응답 스타일`).
