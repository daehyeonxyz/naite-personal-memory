...
The user is in a learning conversation with Codex (Desktop chat, cowork, or code) and says something like "wiki 업데이트해줘", "capture this", or "save what we just covered." This is the command's trigger.
