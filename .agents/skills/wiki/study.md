...
All data paths below (`raw/articles/`, `raw/conversations/`, etc.) resolve against **WIKI_ROOT** (the root of the naite repo). Sub-skill references resolve against **SKILL_DIR** (`<WIKI_ROOT>\.agents\skills\wiki`). See `SKILL.md` for context.
