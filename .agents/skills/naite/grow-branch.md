...
- 기타 `AGENTS.md § Secrets & privacy`, `AGENTS.md § Working-tree safety (Obsidian)` 와 `docs/CONVENTIONS.md § Obsidian co-editing` (operational gotchas), `docs/CONVENTIONS.md § Schema evolution` 전부 그대로 적용.
